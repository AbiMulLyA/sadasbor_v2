...
class PresensiWriteAttendancePage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String imageUrl = 'https://fastly.picsum.photos/id/1/5000/3333.jpg?hmac=Asv2DU3rA_5D1xSe22xZK47WEAN0wjWeFOhzd13ujW4'; // Ganti dengan URL gambar yang valid
    const String alamatMaps = "M43R+VXC, Cintaraja, Kecamatan Singaparna, Kabupaten Tasikmalaya";
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center, // Konten utama rata tengah
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Icon(Icons.location_on_outlined, color: Colors.blue[600], size: 28),
